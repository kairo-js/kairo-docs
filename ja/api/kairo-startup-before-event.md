...
`readonly api:` [`ApiRegistration`](/ja/api/kairo-api-registry)
...
`readonly customCommandRegistry:` [`KairoCustomCommandRegistry`](/ja/api/kairo-custom-command-registry)
...
`readonly events:` [`AddonEventRegistration`](/ja/api/addon-event-registry)
