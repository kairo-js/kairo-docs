...
`readonly api:` [`ApiRegistration`](/ko/api/kairo-api-registry)
...
`readonly customCommandRegistry:` [`KairoCustomCommandRegistry`](/ko/api/kairo-custom-command-registry)
...
`readonly events:` [`AddonEventRegistration`](/ko/api/addon-event-registry)
